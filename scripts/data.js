...
export const skills = [
    {
        ...
        skillName:"HTML",
        skillDesc:"I use HTML to define the structure and hierarchy of a webpage, ensuring that content like headings, paragraphs, and images are organized logically.",
        skillProg:80
    },{
        ...
        skillName:"CSS",
        skillDesc:"I use CSS to handle the visual presentation of the site.",
        skillProg:85
    },{
        ...
        skillName:"ReactJS",
        skillDesc:"I use React to build component-based user interfaces that are fast and interactive.",
        skillProg:80
    },{
        ...
        skillName:"Bootstrap",
        skillDesc:"helps me implement a mobile-first design approach quickly, using its robust grid system and pre-styled components to keep my projects looking polished and consistent.",
        skillProg:70
    },{
...
export const services = [
    {
        ...
        serviceDesc:"I build functional, end-to-end web applications using React along with NodeJS, Django and FastAPI. From setting up the database to deploying the final product, I handle the full lifecycle of a small-to-medium project."
    },
    {
        serviceIcon:`<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 108.36 122.88" style="enable-background:new 0 0 108.36 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M0,0l9.86,110.59l44.25,12.29l44.37-12.3L108.36,0L0,0L0,0L0,0z M86.89,36.18h-51.9l1.24,13.89l49.43,0 l-3.72,41.64l-27.82,7.71l-27.79-7.71l-1.9-21.31h13.62l0.97,10.83l15.11,4.07l0.03-0.01l15.11-4.08l1.57-17.59l-47.01,0 l-3.65-41.02h67.94L86.89,36.18L86.89,36.18L86.89,36.18L86.89,36.18z"/></g></svg>`,
        serviceName:"Web Design",
        serviceDesc:"Focused on simplicity and usability. I design layouts that aren't just pretty, but easy to navigate. I prioritize responsive design so your site looks great whether it's being viewed on a desktop or a smartphone."
    },{
        serviceIcon:`<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 108.36 122.88" style="enable-background:new 0 0 108.36 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M0,0l9.86,110.59l44.25,12.29l44.37-12.3L108.36,0L0,0L0,0L0,0z M86.89,36.18h-51.9l1.24,13.89l49.43,0 l-3.72,41.64l-27.82,7.71l-27.79-7.71l-1.9-21.31h13.62l0.97,10.83l15.11,4.07l0.03-0.01l15.11-4.08l1.57-17.59l-47.01,0 l-3.65-41.02h67.94L86.89,36.18L86.89,36.18L86.89,36.18L86.89,36.18z"/></g></svg>`,
        serviceName:"Backend Development",
        serviceDesc:"I can build robust REST APIs and server-side logic using Flask, Django and NodeJS, ensuring your data is stored securely and flows correctly to your front-end."
    },{
        serviceIcon:`<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 108.36 122.88" style="enable-background:new 0 0 108.36 122.88" xml:space="preserve"><style type="text/css">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path class="st0" d="M0,0l9.86,110.59l44.25,12.29l44.37-12.3L108.36,0L0,0L0,0L0,0z M86.89,36.18h-51.9l1.24,13.89l49.43,0 l-3.72,41.64l-27.82,7.71l-27.79-7.71l-1.9-21.31h13.62l0.97,10.83l15.11,4.07l0.03-0.01l15.11-4.08l1.57-17.59l-47.01,0 l-3.65-41.02h67.94L86.89,36.18L86.89,36.18L86.89,36.18L86.89,36.18z"/></g></svg>`,
        serviceName:"Figma to Code",
        serviceDesc:"I can take your Figma wireframes and translate them into pixel-perfect, responsive HTML/CSS or React components, bringing your vision to the browser exactly as intended."
    },
]