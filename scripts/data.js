...
export const skills = [
    {
        ...
        skillName:"Python",
        skillDesc:"Beyond web development, I use Python for scripting and automation to solve everyday problems. Whether it's writing scripts to handle file management or developing logic-heavy terminal applications, I enjoy using Python to turn complex tasks into simple, automated processes.",
        skillProg:90
    },{
